...
export const metadata: Metadata = {
  title: "FRP Wall Panel Installation Etobicoke | Commercial Contractor Supply | Corevance",
  ...
  alternates: { canonical: "https://corevance.ca/frp-installation-etobicoke" },
  keywords: [
  ...
  openGraph: {
    title: "FRP Wall Panel Installation Etobicoke | Corevance",
    ...
    url: "https://corevance.ca/frp-installation-etobicoke",
    type: "website",
    siteName: "Corevance",
    images: [{ url: "/corevance-logo-full.png", width: 1200, height: 630, alt: "FRP Wall Panel Installation Etobicoke — Corevance" }],
    locale: "en_CA",
  },
};
...
const localSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Corevance — FRP Installation Etobicoke",
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-[#0d1b2a] to-[#1e3a5f] py-20 px-5 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">FRP Wall Panel Installation in Etobicoke</h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                { city: "Vaughan",     href: "/frp-installation-vaughan" },
              ].map(({ city, href }) => (
